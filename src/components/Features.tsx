...
import { Brain, Link2, BarChart3, Workflow, Shield, Rocket } from 'lucide-react';
...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Next-generation AI capabilities that learn from your workflows, predict bottlenecks, and automatically optimize processes for maximum efficiency.",
      phrase: "COMING SOON",
      isComingSoon: true
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {features.map((feature, index) => {
            ...
            return (
              <div 
                key={index}
                className={`group p-6 sm:p-8 bg-white dark:bg-gray-900 rounded-xl border-4 transition-all duration-300 ${
                  feature.isComingSoon 
                    ? 'border-orange-400 dark:border-orange-500 hover:border-orange-300 hover:shadow-lg hover:-translate-y-1 opacity-90' 
                    : 'border-primary-600 dark:border-primary-600 hover:border-primary-500 hover:shadow-lg hover:-translate-y-1'
                }`}
              >
